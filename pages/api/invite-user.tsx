    ...
    switch (requestType) {
      case 'PATCH': {
        ...
        if (isExistingUser) {
          ...
          return res.status(400).json({ message: 'User is already added to the board', status: 400 });
        } 
        ...
        const updateResult = await db
          .collection('boards')
          .updateOne({ _id: boardId }, updateOp);
        ...
        console.log('Created notification for user:', user._id, 'Result:', notificationResult.insertedId);
